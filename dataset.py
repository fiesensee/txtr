...
def load_train(train_path, image_size, classes):
    ...
    for fields in classes:
        ...
        for fl in files:
            ...
            append_image(images, classes, index, labels, fl,
                         img_names, cls, fields, image1)

            image = image[0:1024, 0:2064]

            image2 = cv2.resize(
                image, (image_size, image_size), 0, 0, cv2.INTER_LINEAR)
            append_image(images, classes, index, labels, fl,
                         img_names, cls, fields, image2)
...
def append_image(images, classes, index, labels, fl,
                 img_names, cls, fields, image):
